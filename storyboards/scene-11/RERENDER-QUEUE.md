...
| 13-4 | Content-safety rejected Ji-lan monologue prompt (HITLER / racial ideology terms) | Stripped "cult-leader" and "monologue" — plain portrait prompt + safety_tolerance 5 | **DONE** — re-roll PASSED, vision-checked clean. |
| 13-12 | Content-safety rejected "Ji-lan dragging MAMA" prompt (tied-hostage framing) | Softened to "she is being rescued, not harmed" + safety_tolerance 5 | **DONE** — re-roll PASSED. |
| 16-3 | Empty `image_urls` (baby panel had no character ref) | Uses Jasmine as tonal anchor | **DONE** — re-roll PASSED. |
| 16-4 | Empty `image_urls` (eye close-up had no ref) | Uses Jasmine as tonal anchor | **DONE** — re-roll PASSED, vision-checked clean. |

## Cost

~~3 panels remaining × $0.15 = **$0.45** to clear the queue.~~ **Queue cleared.**
